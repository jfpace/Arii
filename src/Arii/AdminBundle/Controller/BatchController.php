...
class BatchController extends Controller
{
    ...
    {
        return $this->render('AriiAdminBundle:Batch:list.html.twig');
    }
    ...
    public function installerAction($mode='new',$id=-1)
    {
        ...
        return $this->render('AriiAdminBundle:Batch:installer.html.twig', array( 'mode'=> $mode, 'id' => $id ));
    }
    ...
    {
         return $this->render('AriiAdminBundle:Batch:contextmenu.html.twig');
    }

    public function toolbarEditAction()
    {
        return $this->render('AriiAdminBundle:Batch:toolbar_edit.html.twig' );
    }

    public function toolbarListAction()
    {
        return $this->render('AriiAdminBundle:Batch:toolbar_list.html.twig');
    }
